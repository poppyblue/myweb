<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:85:"D:\phpStudy\PHPTutorial\WWW\MyWeb\public/../application/admin\view\student\index.html";i:1561079601;s:75:"D:\phpStudy\PHPTutorial\WWW\MyWeb\application\admin\view\common\header.html";i:1558084370;s:75:"D:\phpStudy\PHPTutorial\WWW\MyWeb\application\admin\view\common\footer.html";i:1558084370;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8">
        ...
        <div class="layui-card-body">
            <div class="table-head-btn">
                <form class="layui-form seller-form">
                    ...
                    <a href="<?php echo url('edit'); ?>" class="layui-btn layui-btn-sm" style="float:right;">添加学生</a>
                </form>
            </div>
        ...
        table.on('tool(list)', function (obj) {
            ...
            if (obj.event === 'del') {
                layer.confirm('您确定要删除吗？', function (index) {
                    ...
                    $.post("<?php echo url('stuDel'); ?>", {id: data.id}, function (res) {
                        layer.close(loading);
                        if (res.code === 1) {
