<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:83:"D:\phpStudy\PHPTutorial\WWW\MyWeb\public/../application/admin\view\index\index.html";i:1560156166;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<div class="layui-layout layui-layout-admin">
    ...
    <div class="layui-header header">
        <div class="layui-main mag0">
            <a href="#" class="logo"><?php echo \think\Config::get('sys_name'); ?></a>
            <!-- 显示/隐藏菜单 -->
            <a href="javascript:;" class="seraph hideMenu"><i class="fa fa-outdent"></i></a>
            <!-- 顶级菜单 -->
           ...
           -->
            ...
            <ul class="layui-nav top_menu">
                <li class="layui-nav-item" pc>
                    <a href="javascript:;" class="clearCache"><i class="fa fa-trash-o fa-lg"></i><cite>清除缓存</cite><span class="layui-badge-dot"></span></a>
                </li>
                <li class="layui-nav-item" id="userInfo">
                    <a id="logout" href="<?php echo url('index/logout'); ?>"><i class="fa fa-sign-out fa-lg"></i><cite>退出</cite></a>
    ...
    <div class="layui-side layui-bg-black">
        <div class="user-photo">
            ...
            <p>你好！<span class="userName"><?php echo session('username'); ?></span>, 欢迎登录</p>
        </div>
    ...
    <div  class="layui-body layui-form">
        <div class="layui-tab mag0" style="margin: 0" lay-filter="bodyTab" id="top_tabs_box">
            ...
            <ul class="layui-nav closeBox">
                <li class="layui-nav-item">
                    ...
                    <dl class="layui-nav-child">
                        ...
                        <dd><a href="javascript:;" class="closePageOther"><i class="fa fa-times"></i> 关闭其他</a></dd>
                        <dd><a href="javascript:;" class="closePageAll"><i class="fa fa-window-close"></i> 关闭全部</a></dd>
                    </dl>
                </li>
            </ul>
